...
def test_empty_courses_list(chromium_page_with_state: Page):
    ...
    desc_title = chromium_page_with_state.get_by_test_id('courses-list-empty-view-description-text')
    expect(desc_title).to_be_visible()
    expect(desc_title).to_have_text('Results from the load test pipeline will be displayed here')

    chromium_page_with_state.wait_for_timeout(2500)
