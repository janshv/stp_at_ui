...
class CreateCourseFormComponent(BaseComponent):
    ...
    @allure.step('Check visible "{title}" and other fields of create course form component')
    ...
    @allure.step('Fill "{title}" and other fields of create course form component')
